...
<style lang="stylus" rel="stylesheet/stylus">
  ...
  .ratingselect
    .rating-type
      ...
      .block
        display: inline-block; padding: 8px 12px; margin-right: 8px; line-height: 16px;
        border-radius: 1px; font-size: 12px; color: rgb(77, 85, 93);
        &.active
          color: #fff
        .count
          margin-left: 2px;
    ...
    .switch
      padding: 12px 18px; line-height: 24px; border-bottom: 1px solid rgba(7, 17, 27, 0.1);
      color: rgb(147, 153, 159); font-size: 0;
      &.on
        .icon-check_circle
          color: #00c850
      .icon-check_circle
        display: inline-block; vertical-align: top; margin-right: 4px; font-size: 24px;
      .text
